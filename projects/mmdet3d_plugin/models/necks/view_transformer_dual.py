...
class DualViewTransformerFull(LSSViewTransformerBEVDepth):
    def __init__(self, pc_range, bev_h=200, bev_w=200, num_height=13, collapse_z=True, loss_semantic_weight=25, 
    ...
    def forward(self, input, stereo_metas=None):
        ...
        return bev_feat, depth, (bev_mask, "_")
