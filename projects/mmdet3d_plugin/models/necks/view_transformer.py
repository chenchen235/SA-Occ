...
class LSSViewTransformerBEVDepth(LSSViewTransformer):
    ...
    def get_depth_loss(self, depth_labels, depth_preds):
        ...
        """
# torch.Size([8, 6, 256, 704]) torch.Size([48, 88, 16, 44])

        # print(depth_labels.shape, depth_preds.shape) #torch.Size([8, 6, 256, 704]) torch.Size([24, 88, 16, 44]) 
        depth_labels = self.get_downsampled_gt_depth(depth_labels)      # (B*N_views*fH*fW, D)  [16896, 88]
